  ...
  return (
    <section id="work" className="flex flex-col min-h-screen ">
      ...
      >
        {monthlyEvents.map((project, index) => (
          ...
          >
            ...
            <div
              ...
              className="absolute inset-0 hidden md:block duration-200 -z-10 clip-path md:group-hover:bg-black"
            />
        ...
        <div
          ref={previewRef}
          className="fixed -top-2/6 left-0 z-50 overflow-hidden border-8 border-black pointer-events-none w-[400px] md:block hidden opacity-0"
        >
          {currentIndex !== null && (
            <img
